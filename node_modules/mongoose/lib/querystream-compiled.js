...
function QueryStream(query, options) {
  ...
  this._inline = T_INIT;
  this._running = false;
  this._transform = options && typeof options.transform === 'function' ? options.transform : K;
...
QueryStream.prototype._onNextObject = function _onNextObject(err, doc) {
  ...
  if (!opts.populate) {
    return opts.lean === true ? emit(this, doc) : createAndEmit(this, null, doc);
  }
  ...
  _this.query.model.populate(doc, pop, function (err, doc) {
    ...
    return opts.lean === true ? emit(_this, doc) : createAndEmit(_this, pop, doc);
  });
};
