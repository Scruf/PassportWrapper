...
Mongoose.prototype.createConnection = function (uri, options) {
  ...
  if (arguments.length) {
    ...
    } else if (options && options.replset && (options.replset.replicaSet || options.replset.rs_name)) {
      conn.openSet.apply(conn, arguments);
    } else {
...
MongooseThenable.prototype.then = function (onFulfilled, onRejected) {
  ...
  if (!this.$opPromise) {
    return new Promise.ES6(function (resolve, reject) {
      reject(new Error('Can only call `.then()` if connect() or disconnect() ' + 'has been called'));
