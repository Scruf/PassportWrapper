...
define('HTMLElement', {
  ...
  attributes: ['id', 'title', 'lang', 'dir', { prop: 'className', attr: 'class', normalize: function (s) {
      return s || '';
    } }]
});
...
define('HTMLFormElement', {
  ...
  attributes: ['name', { prop: 'acceptCharset', attr: 'accept-charset' }, 'action', 'enctype', 'method', 'target']
});
...
define('HTMLLinkElement', {
  ...
  attributes: [{ prop: 'disabled', type: 'boolean' }, 'charset', 'href', 'hreflang', 'media', 'rel', 'rev', 'target', 'type']
});

define('HTMLMetaElement', {
  tagName: 'META',
  attributes: ['content', { prop: 'httpEquiv', attr: 'http-equiv' }, 'name', 'scheme']
});
...
define('HTMLStyleElement', {
  tagName: 'STYLE',
  attributes: [{ prop: 'disabled', type: 'boolean' }, 'media', 'type']
});
...
define('HTMLSelectElement', {
  ...
  attributes: [{ prop: 'disabled', type: 'boolean' }, { prop: 'multiple', type: 'boolean' }, 'name', { prop: 'size', type: 'long' }, { prop: 'tabIndex', type: 'long' }]
});

define('HTMLOptGroupElement', {
  tagName: 'OPTGROUP',
  attributes: [{ prop: 'disabled', type: 'boolean' }, 'label']
});
...
define('HTMLInputElement', {
  ...
  attributes: ['accept', 'accessKey', 'align', 'alt', { prop: 'disabled', type: 'boolean' }, { prop: 'maxLength', type: 'long' }, 'name', { prop: 'readOnly', type: 'boolean' }, { prop: 'size', type: 'long' }, 'src', { prop: 'tabIndex', type: 'long' }, { prop: 'type', normalize: function (val) {
...
define('HTMLTextAreaElement', {
  ...
  attributes: ['accessKey', { prop: 'cols', type: 'long' }, { prop: 'disabled', type: 'boolean' }, { prop: 'maxLength', type: 'long' }, 'name', { prop: 'readOnly', type: 'boolean' }, { prop: 'rows', type: 'long' }, { prop: 'tabIndex', type: 'long' }]
});
...
define('HTMLButtonElement', {
  ...
  attributes: ['accessKey', { prop: 'disabled', type: 'boolean' }, 'name', { prop: 'tabIndex', type: 'long' }, 'value']
});
...
define('HTMLLabelElement', {
  ...
  attributes: ['accessKey', { prop: 'htmlFor', attr: 'for' }]
});
...
define('HTMLUListElement', {
  tagName: 'UL',
  attributes: [{ prop: 'compact', type: 'boolean' }, 'type']
});

define('HTMLOListElement', {
  tagName: 'OL',
  attributes: [{ prop: 'compact', type: 'boolean' }, { prop: 'start', type: 'long' }, 'type']
});

define('HTMLDListElement', {
  tagName: 'DL',
  attributes: [{ prop: 'compact', type: 'boolean' }]
});
...
define('HTMLLIElement', {
  tagName: 'LI',
  attributes: ['type', { prop: 'value', type: 'long' }]
});
...
define('HTMLPreElement', {
  tagName: 'PRE',
  attributes: [{ prop: 'width', type: 'long' }]
});
...
define('HTMLBaseFontElement', {
  tagName: 'BASEFONT',
  attributes: ['color', 'face', { prop: 'size', type: 'long' }]
});
...
define('HTMLHRElement', {
  tagName: 'HR',
  attributes: ['align', { prop: 'noShade', type: 'boolean' }, 'size', 'width']
});
...
define('HTMLAnchorElement', {
  ...
  attributes: ['accessKey', 'charset', 'coords', 'hreflang', 'name', 'rel', 'rev', 'shape', { prop: 'tabIndex', type: 'long' }, 'target', 'type']
});
...
define('HTMLImageElement', {
  ...
  attributes: ['name', 'align', 'alt', 'border', { prop: 'height', type: 'long' }, { prop: 'hspace', type: 'long' }, { prop: 'isMap', type: 'boolean' }, 'longDesc', { prop: 'src', type: 'string', read: false }, 'useMap', { prop: 'vspace', type: 'long' }, { prop: 'width', type: 'long' }]
});
...
define('HTMLObjectElement', {
  ...
  attributes: ['code', 'align', 'archive', 'border', 'codeBase', 'codeType', 'data', { prop: 'declare', type: 'boolean' }, { prop: 'height', type: 'long' }, { prop: 'hspace', type: 'long' }, 'name', 'standby', { prop: 'tabIndex', type: 'long' }, 'type', 'useMap', { prop: 'vspace', type: 'long' }, { prop: 'width', type: 'long' }]
});
...
define('HTMLAppletElement', {
  tagName: 'APPLET',
  attributes: ['align', 'alt', 'archive', 'code', 'codeBase', 'height', { prop: 'hspace', type: 'long' }, 'name', 'object', { prop: 'vspace', type: 'long' }, 'width']
});
...
define('HTMLAreaElement', {
  tagName: 'AREA',
  attributes: ['accessKey', 'alt', 'coords', 'href', { prop: 'noHref', type: 'boolean' }, 'shape', { prop: 'tabIndex', type: 'long' }, 'target']
});
...
define('HTMLScriptElement', {
  ...
  attributes: [{ prop: 'defer', 'type': 'boolean' }, 'htmlFor', 'event', 'charset', 'type', 'src']
});
...
define('HTMLTableColElement', {
  ...
  attributes: [{ prop: 'span', type: 'long' }, 'align', { prop: 'ch', attr: 'char' }, { prop: 'chOff', attr: 'charoff' }, 'vAlign', 'width']
});
...
define('HTMLTableSectionElement', {
  ...
  attributes: ['align', { prop: 'ch', attr: 'char' }, { prop: 'chOff', attr: 'charoff' }, 'vAlign']
});
...
define('HTMLTableRowElement', {
  ...
  attributes: ['align', { prop: 'ch', attr: 'char' }, { prop: 'chOff', attr: 'charoff' }, 'vAlign', 'bgColor']
});
...
define('HTMLTableCellElement', {
  ...
  attributes: [{ prop: 'colSpan', type: 'long' }, { prop: 'rowSpan', type: 'long' }, 'align', 'axis', 'height', 'width', { prop: 'ch', attr: 'char' }, { prop: 'chOff', attr: 'charoff' }, { prop: 'noWrap', type: 'boolean' }, 'vAlign', 'bgColor']
});
...
define('HTMLFrameElement', {
  ...
  attributes: ['frameBorder', 'longDesc', 'marginHeight', 'marginWidth', 'name', { prop: 'noResize', type: 'boolean' }, 'scrolling', { prop: 'src', type: 'string', write: false }]
});
...
define('HTMLMediaElement', {
  ...
  attributes: [{ prop: 'autoplay', type: 'boolean' }, { prop: 'controls', type: 'boolean' }, 'crossOrigin', 'currentTime', 'preload', { prop: 'loop', type: 'boolean' }, 'mediaGroup']
});
...
define('HTMLVideoElement', {
  ...
  attributes: [{ prop: 'height', type: 'long' }, 'poster', { prop: 'videoHeight', type: 'long' }, { prop: 'videoWidth', type: 'long' }, { prop: 'width', type: 'long' }]
});
...
define('HTMLEmbedElement', {
  tagName: 'EMBED',
  attributes: ['src', 'type', { prop: 'width', type: 'long' }, { prop: 'height', type: 'long' }, 'align', 'name']
});
...
define('HTMLTrackElement', {
  tagName: 'TRACK',
  attributes: ['kind', 'src', 'srclang', 'label', { prop: 'default', type: 'boolean' }],
  proto: {
    get readyState() {
      return 0;
    }
