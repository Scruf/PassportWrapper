...
module.exports = function (core) {
  ...
  core.Node.prototype.contains = function (other) {
    return Boolean(other instanceof core.Node && (this === other || this.compareDocumentPosition(other) & DOCUMENT_POSITION_CONTAINED_BY));
  };
  ...
  function nodeEquals(a, b) {
    ...
    switch (a.nodeType) {
      case NODE_TYPE.DOCUMENT_TYPE_NODE:
        ...
        if (privatesA.name !== privatesB.name || privatesA.publicId !== privatesB.publicId || privatesA.systemId !== privatesB.systemId) {
          return false;
        }
        break;
